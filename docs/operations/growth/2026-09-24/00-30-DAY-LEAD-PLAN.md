...
The numbered sources are in [`00-30-DAY-LEAD-PLAN-part2.md`](00-30-DAY-LEAD-PLAN-part2.md) in this folder: evidence files E1-E12, live reads L1-L5 and external sources S1-S43, each with its URL, publication date and read time. They were moved there to keep each file under about 40 KB.
