  ...
  return (
    <article className="bg-white min-h-[calc(100dvh-80px)] px-4 sm:px-8 py-10 sm:py-14">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        {post.answer && (
          <aside className="mb-8 border-l-4 border-blue-400 bg-blue-50/40 p-5">
            <p className="text-xs font-semibold uppercase tracking-wider text-blue-700 mb-2">At a glance</p>
            <p className="text-base leading-relaxed text-slate-800">{post.answer}</p>
          </aside>
        )}
