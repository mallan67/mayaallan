      ...
      <div className="bg-white flex flex-col flex-1 min-h-0">
        ...
        <div className="shrink-0 px-5 sm:px-8 pt-8 pb-5 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <div className="w-12 h-12 rounded-2xl bg-liquid-blue-wash flex items-center justify-center mx-auto mb-4">
            ...
            {/* Disclosure banner */}
            <div className="inline-block bg-[#F0F7FF] border border-[#D6E8FA] rounded-xl px-4 py-2.5">
