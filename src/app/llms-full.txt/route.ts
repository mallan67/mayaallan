...
export async function GET() {
  ...
  lines.push("")
  lines.push("### Nervous System Reset tool")
  lines.push(`Source: ${SITE_URL}/nervous-system-reset`)
  lines.push("")
  ...
  lines.push("")
  lines.push("### Integration Journal")
  lines.push(`Source: ${SITE_URL}/integration-journal`)
  lines.push("")
  lines.push("A free downloadable 7-day PDF journal with research-informed daily prompts")
  lines.push("for preparation, journey, integration, and shadow work. A structured")
  lines.push("reflection practice for turning a temporary insight into durable change.")
  lines.push("")
  lines.push("---")
  lines.push("")
